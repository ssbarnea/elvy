...
// / import { ServiceSetup } from 'yaml-language-server/utils/serviceSetup';

import * as assert from 'assert';
import * as path from 'path';
import { Diagnostic, DiagnosticSeverity } from 'vscode-languageserver';
// import { expect } from 'chai';
import { SettingsState, TextDocumentTestManager } from 'yaml-language-server/lib/esm/yamlSettings';
// /out/server / src / yamlSettings';
// from '../src/yamlSettings';
// # /languageserver/handlers/validationHandlers
...
import { ServiceSetup } from '../src/utils/serviceSetup';
import { createDiagnosticWithData, createExpectedError } from '../src/utils/verifyError';
import { SCHEMA_ID, setupLanguageService, setupSchemaIDTextDocument } from '../src/utils/testHelper';
// out / server / src / languageserver / handlers / validationHandlers';
// '../src/languageservice/yamlLanguageService';
// import { KUBERNETES_SCHEMA_URL } from '../src/languageservice/utils/schemaUrls';
// import { IProblem } from 'yaml-language-server/lib/esm/languageservice/parser/jsonParser07';
// out / server / src / languageservice / parser / jsonParser07';
...
describe('Validation Tests', () => {
  ...
  before(() => {
    languageSettingsSetup = new ServiceSetup()
      ...
      .withSchemaFileMatch({ uri: 'foo', fileMatch: ['.drone.yml'] })
      .withSchemaFileMatch({ uri: 'https://json.schemastore.org/drone', fileMatch: ['.drone.yml'] })
      .withSchemaFileMatch({ uri: 'foo', fileMatch: ['test.yml'] })
  ...
  describe('Test with custom kubernetes schemas', () => {
